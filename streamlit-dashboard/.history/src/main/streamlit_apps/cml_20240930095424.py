...
background-image: url("https://getwallpapers.com/wallpaper/full/a/2/5/1034922-gorgerous-rain-forest-wallpaper-2560x1600-for-iphone.jpg");
background-size: cover;
}
</style>
'''

st.markdown(bpage_bg_img, unsafe_allow_html=True)
