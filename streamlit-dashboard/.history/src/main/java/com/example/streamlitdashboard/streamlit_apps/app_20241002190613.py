...
def main():
    ...
    st.title("Uplift: Your Personal Therapist Bot")
    ...
    if anxiety_button or depression_button or relationships_button or general_button:
        try:
            ...
            response = model.generate_content(f"You are a mental health care chatbot. You must reply to the following messages as a mental health assistant will. {topic}. {message}")
